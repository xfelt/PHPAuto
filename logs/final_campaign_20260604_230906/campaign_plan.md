...
- Generated at: 2026-06-04 23:09:06
- Solver time limit: 300s per run
- This plan is generated before solver execution.

## Planned Counts

- scalability (enabled): 23 reported rows, 46 solver calls (two-stage lexicographic baseline)
- topology_baseline (enabled): 10 reported rows, 20 solver calls (two-stage lexicographic baseline)
