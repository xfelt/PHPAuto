...
| C1 (C1) | N/A | N/A | N/A | N/A | N/A | N/A | N/A | N/A |
| C2 (C2) | N/A | N/A | N/A | N/A | N/A | N/A | N/A | N/A |

### Key Findings

- **⚠️ Model infeasibility detected**: Variant A returned status: INFEASIBLE
  This may indicate insufficient supplier capacity or constraint conflicts.
- **⚠️ Model infeasibility detected**: Variant B returned status: INFEASIBLE
  This may indicate insufficient supplier capacity or constraint conflicts.
- **⚠️ Model infeasibility detected**: Variant C1 returned status: INFEASIBLE
  This may indicate insufficient supplier capacity or constraint conflicts.
- **⚠️ Model infeasibility detected**: Variant C2 returned status: INFEASIBLE
  This may indicate insufficient supplier capacity or constraint conflicts.

**Note**: Due to infeasibility, detailed analysis is not available for this BOM.
**Root Cause**: The model is infeasible because some leaf nodes require quantities that exceed the total capacity of available suppliers.
For example, node 40 requires 1080 units (20 × 54), but suppliers 1-10 have a combined capacity of only 815 units.
This is a structural constraint issue, not a bug in the optimization model.
