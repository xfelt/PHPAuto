...
int obj_primary = 1;         // Primary objective: 1=Cost, 2=DIO, 3=WIP, 4=Emissions
...
// Program parameters
 ...
 string nodeFile = "bom_supemis_13.csv";
 string nodeSuppFile = "supp_list_13.csv";
 string suppDetailsFile = "supp_details_supeco.csv";
 int service_t = 1;
 int EmisCap = 2500000;
 float EmisTax = 0;
