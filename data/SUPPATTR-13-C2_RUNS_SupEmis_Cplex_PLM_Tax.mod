...
// Program parameters
 ...
 string nodeFile = "C:/Users/Xfeltech/OneDrive/Documents/GitHub/PHPAuto/config/../data/bom_supemis_13.csv";
 string nodeSuppFile = "C:/Users/Xfeltech/OneDrive/Documents/GitHub/PHPAuto/config/../data/supp_list_13.csv";
 string suppDetailsFile = "C:/Users/Xfeltech/OneDrive/Documents/GitHub/PHPAuto/config/../data/supp_details_supeco.csv";
 int service_t = 1;
 int EmisCap = 2500000;
 float EmisTax = 0;
...
dexpr float QualityPenalty = 0.5 * sum(i in N)( unit_price[i]*sum(j in S)(q[i][j]*(1.0 - sup[j][5])) );
dexpr float ReliabilityPenalty = 0.5 * sum(i in N)( unit_price[i]*sum(j in S)(q[i][j]*(1.0 - sup[j][6])) );
